const ffmmpeg = require('fluent-ffmpeg');
const fs = require('fs');
...
async function inverted()
{
     ...
     // .audioFilters([
                //     'asetrate=44100*1.5',  // Zwiększa wysokość tonu
                //     'atempo=0.8',          // Lekko zwalnia tempo
                //     'aecho=0.8:0.9:1000:0.3', // Dodaje efekt echo
                //     'aphaser=0.9'          // Dodaje fazowanie dla efektu przestrzennego
                //   ])
                //   .outputOptions([
